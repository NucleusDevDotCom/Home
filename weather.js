document.addEventListener('readystatechange', event => { 
	...
	return '<div style="float:right;height:55px; width:100px;background-color:#EEEE; border:2px solid; boarder-radius:3px;margin-right:7px;">' +
	       '<div style="display:inline-block;border:0px solid;width:100%; height:27px;text-align:center;">' + name + '</div></br>' + 
	       '<div style="display:inline-block;border:0px solid;width:50px; height:27px;text-align:right;">' + temp + '</div>' +                         
